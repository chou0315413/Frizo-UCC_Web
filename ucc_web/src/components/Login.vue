                    ...
                    <div class="modal-body">
                        ...
                        <div class="logInWay">
                            <button type="button" class="btn btn-outline-secondary mb-2 btnWidth">
                                <a href="http://localhost:8080/oauth2/authorize/google?redirect_uri=http://localhost:3000/oauth2/redirect">Google登入</a>
                            </button>
                            <br/>
                            <button type="button" class="btn btn-outline-secondary mb-2 btnWidth">
                                <a href="http://localhost:8080/oauth2/authorize/facebook?redirect_uri=http://localhost:3000/oauth2/redirect">Facebook登入</a>
                            </button>
                            <br/>
