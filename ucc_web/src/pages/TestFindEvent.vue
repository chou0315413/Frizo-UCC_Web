    ...
    <div class="user">
        ...
        <div class="main">
            ...
            <form>
                ...
                <div>
                    <label>依照以下排序:</label>
                    <label><input type="radio" name="sortBy" value="createdAt" checked v-model="searchSpec.sortBy">發表時間</label>
                    <label><input type="radio" name="sortBy" value="likes" v-model="searchSpec.sortBy">熱度</label>
                    <label><input type="radio" name="sortBy" value="eventStartTime" v-model="searchSpec.sortBy">活動開始時間</label>
                    <label><input type="radio" name="sortBy" value="registrationDeadline" v-model="searchSpec.sortBy">報名截止時間</label>
                </div>

                <div>
                    <label>選擇升降序:</label>
                    <label><input type="radio" name="direction" value="DESC" v-model="searchSpec.direction" checked>降序</label>
                    <label><input type="radio" name="direction" value="ASC" v-model="searchSpec.direction">升序</label>
                </div>
